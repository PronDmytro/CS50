...
public class Assigment11Tests {
    public static void main(String[] args) {
        checkCase(new String[]{"((24-22)*(a) + cos(5^4-(600+25)))/sqrt(25)+sin(0) + b - (-1)", "a = 2", "b=4"}, "6");
        checkCase(new String[]{"log10(10)"}, "1.0");
        checkCase(new String[]{"log10(sin(cos(atan(-75))))", "abc = "}, "-1.8751127296882348");
        checkCase(new String[]{"log10(a)", "a = -75"}, "NaN");
...
//        checkCase(new String[]{"3-(8-(2+2+(3^2))^2)+(33+53)"}, "250.0");
        ...
        checkCase(new String[]{"sin(3)"}, "0.14112");// functions below
        checkCase(new String[]{"sin(3+3)"},"-0.27942");
        checkCase(new String[]{"sin(3+3) + cos(4^2)"}, "-1.23707");
        checkCase(new String[]{"sin(3+3) + sin(4^2)"}, "-0.56732");
        checkCase(new String[]{"log10(100)"}, "2.00000");
        checkCase(new String[]{"1+(2+3*(4+5-sin(45*cos(a))))/7", "a=55"}, "4.78322");
        checkCase(new String[]{"-(1+23/4^5+(-67/(cos(8)^9+sin(tan(atan(log2(10)^11)/12)*13)+14-1516))^17-18+(-19^(-20))*" +
...
//        checkCase(new String[]{"-5-10+a^2-b^codi+1.44", "codi =5", "a=5", "b=5"}, "6885.44000"); // not mendatory with args
